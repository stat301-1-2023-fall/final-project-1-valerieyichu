...
```
Interestingly, **there is no relationship between a *book's average rating* and *its rank based on the number of ratings it received*.** 
...
I'm very surprised at this finding. I had expected the rank of the number of ratings a book received to have at least some correlation with the average rating. **So I guess people are neither more nor less inclined to rate a book whether they hated or loved that book.** 


Now let's look at the distribution of the most highly rated books. 
