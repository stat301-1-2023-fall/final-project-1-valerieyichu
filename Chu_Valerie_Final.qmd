...
#### Question 1, Part 2: Do people hate-rate or love-rate books?
...
**This graph is so green. How many books and what percent of books on Goodreads are written in English?**
```{r, echo = FALSE}
...
- 1. This dataset is a dataset of the 10k most rated books on Goodreads. The graph above is so green because most of these books are in some variety of English. Unsurprisingly, the people who use Goodreads, an American-based company, mostly rate books written in English and other European languages. 
