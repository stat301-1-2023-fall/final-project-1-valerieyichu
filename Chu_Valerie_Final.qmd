...
**This graph is so green. How many books are written in English?**
```{r, echo = FALSE}
...
- 1. This dataset is a dataset of the 10k most rated books on Goodreads. The graph above is so green because most of these books are in some form of English. Unsurprisingly, the people who use Goodreads, an America-based company, mostly rate books written English and other European languages. 

- 2. **There appears to be no relationship between a *book's average rating* and *its rank based on the number of ratings it received*.**
