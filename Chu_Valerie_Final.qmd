...
This dataset is a dataset of the 10,000 most rated books on Goodreads. The graph above, @fig-1, is so green because most of these books are in some variety of English. Unsurprisingly, the people who use Goodreads, an American-based company, mostly rate books written in English and other European languages. 
...
A few things I found interesting about the distribution of the average rating of books on Goodreads, as seen in @fig-2:
...
I'm not surprised that @tbl-6 shows there's no correlation between how many books someone rated and whether they had a higher or lower average rating. 

@tbl-2 looked at whether there was a correlation between a book's average rating and its rank it based on the number of ratings it received.
